...
setup(name=package_name, version="0.1.0", packages=find_packages(),
    ...
    description="AVM simulation avm_stitcher", license="Apache-2.0",
    entry_points={"console_scripts": ["avm_stitcher_node = avm_stitcher.ros_node:main"]})
