...
setup(name=package_name, version="0.1.0", packages=find_packages(),
    ...
    description="AVM simulation scene_editor", license="Apache-2.0",
    entry_points={"console_scripts": ["scene_editor_node = scene_editor.ros_node:main"]})
