...
setup(name=package_name, version="0.1.0", packages=find_packages(),
    ...
    description="AVM simulation gs_renderer", license="Apache-2.0",
    entry_points={"console_scripts": ["gs_renderer_node = gs_renderer.ros_node:main"]})
